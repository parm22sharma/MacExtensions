...
//        jumpAnimation.animation.animationEvents = @[[SCNAnimationEvent animationEventWithKeyTime:0 block:^(CAAnimation *animation, id animatedObject, BOOL playingBackward) { [self playJumpSound]; }]];
        jumpAnimation.animation.animationEvents = @[[SCNAnimationEvent animationEventWithKeyTime:0 block:^(id<SCNAnimation>  _Nonnull animation, id  _Nonnull animatedObject, BOOL playingBackward) {
            [self playJumpSound];
        }]];
...
//        spinAnimation.animation.animationEvents = @[[SCNAnimationEvent animationEventWithKeyTime:0 block:^(CAAnimation *animation, id animatedObject, BOOL playingBackward) { [self playAttackSound]; }]];
        spinAnimation.animation.animationEvents = @[[SCNAnimationEvent animationEventWithKeyTime:0 block:^(id<SCNAnimation>  _Nonnull animation, id  _Nonnull animatedObject, BOOL playingBackward) {
